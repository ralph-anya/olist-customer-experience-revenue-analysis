...
-- 2. Create orders table and inserting values. 
...
order_estimated_delivery_date = NULLIF(@estimated,'');
 ...
 -- 3. Create and populate order_items table
...
LOAD DATA LOCAL INFILE 'C:/Users/USER/Desktop/MySQL/Olist_dataset/order_items.csv'
...
IGNORE 1 ROWS;
 ...
 -- 4. Create and populate order_reviews table
